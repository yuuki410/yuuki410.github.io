...
# Site
title: Tachibana Yuuki has Super Cow Power
subtitle: 'Const Awesome'
...
deploy:
  type: git
  repo: git@github.com:yuuki410/yuuki410.github.io.git
  branch: gh-pages
```

```yaml ~/yuuki410.github.io/_config.next.yml
# ===============================================================
# Edited from:
...
```bash ~/yuuki410.github.io
hexo new "creat-blog"
vim source/_posts/creat-blog.md
```
...
随后在浏览器中打开locallhost看效果。

```bash ~/yuuki410.github.io
hexo deploy # 可简写为 hexo d
```

至此，博客已推送到github上并可在github pages中查看。